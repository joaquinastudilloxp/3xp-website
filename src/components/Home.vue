		...
		<div class="container">
			<div class="nav-scroller py-1 mb-2">
				<nav class="nav d-flex justify-content-between">
					...
					<a class="p-2 text-muted" href="#">Live</a>
		...
		<div class="container">
			...
			<div class="row mb-2">
				<div class="col-lg-4 rounded-card">
					<img :src="require('../assets/card1.png')" class="bd-placeholder-img rounded-circle" width="280" height="280" />
					<h3>Baccarat</h3>
				</div>
				<div class="col-lg-4 rounded-card">
					<img :src="require('../assets/card2.png')" class="bd-placeholder-img rounded-circle" width="280" height="280" />
					<h3>Slots</h3>
				</div>
				<div class="col-lg-4 rounded-card">
					<img :src="require('../assets/card3.png')" class="bd-placeholder-img rounded-circle" width="280" height="280" />
					<h3>Online Poker</h3>
				</div>
			</div>
		</div>
				...
				<div class="col-md-6">
					<div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
						...
						<div class="col-auto d-none d-lg-block">
							<img :src="require('../assets/racing.png')" class="bd-placeholder-img" width="200" height="250" />
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
						...
						<div class="col-auto d-none d-lg-block">
							<img :src="require('../assets/football.png')" class="bd-placeholder-img" width="200" height="250" />
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
						<div class="col p-4 d-flex flex-column position-static">
							<h3 class="mb-0">Golf</h3>
							<p class="card-text mb-auto">Interested in XX? Click the link below and you will be able to get right in on the latest action from Cheltenham and other race courses around the world.</p>
							<a href="#" class="stretched-link">Continue reading</a>
						</div>
						<div class="col-auto d-none d-lg-block">
							<img :src="require('../assets/golf.png')" class="bd-placeholder-img" width="200" height="250" />
						</div>
					</div>
				</div>
			</div>
